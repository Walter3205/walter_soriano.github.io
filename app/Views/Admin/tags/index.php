    ...
    <title>dymstudio | Listado de Etiquetas</title>
</head>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a class="btn btn-primary" href="tags/create"><span>Crear Nueva Etiqueta</span></a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                                <?php foreach ($tags as $tag) { ?>
                                    <tr>
                                        ...
                                        <td >
                                            <a class="btn btn-primary btn-sm centrar" href="tags/<?php echo $tag->id?>"><span>Editar</span></a>
                                        </td>
                                        <td>
                                            <form action="tags/destroy/<?php echo $tag->id?>" class="delete_tag" method="POST">
                                                <?= csrf_field() ?>
...
<script>
    $(document).ready(function() {
        ...
        $('.delete_tag').submit(function(e){
            e.preventDefault();
            Swal.fire({
                title: 'Quiere eliminar esta Etiqueta?',
                text: "La etiqueta se elminará definitvamente.",
                icon: 'warning',
