<title>dymstudio | Editar Usuario</title>
</head>
                ...
                <div class="col-md-9 ">
                    ...
                    <?php if (isset($error)) : ?>
                        ...
                        <div class="card-body">
                            ...
                            <form action="edit/<?php echo $usr->id ?>" method="post" enctype="multipart/form-data">
                                    <?= csrf_field() ?>
                                    <div class="form-group row">
                                        <label for="firstname" class="col-sm-4 col-form-label">Nombres</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="firstname" id="firstname" placeholder="Nombres" value="<?= $usr->firstname ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lastname" class="col-sm-4 col-form-label">Apellidos</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="lastname" id="lastname" placeholder="Apellidos" value="<?= $usr->lastname ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8 mt-2">
                                            ...
                                            <?php foreach ($roles as $role) { ?>
                                                <div class="icheck-primary d-inline mr-3">
                                                    <input type="radio" id="<?php echo $role->name; ?>" name="roles" value="<?php echo $role->id; ?>" <?php if($usr->role_id == $role->id) : echo 'checked'; endif;?> required>
                                    ...
                                    <div class="form-group row centrar">
                                        <?php if (isset($usr->image)){ ?>
                                            <img id="imagen" width="300px" src="<?php echo base_url($usr->image) ?>" alt="">
                                        <?php }else{ ?>
